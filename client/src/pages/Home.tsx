...
function SignalMark({ small = false }: { small?: boolean }) {
  return <span className={`signal-mark ${small ? "signal-mark--small" : ""}`} aria-hidden="true"><img className="signal-mark__image" src="/assets/suleman-signal-mark.png" alt="" /></span>;
}
